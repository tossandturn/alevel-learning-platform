...
assert.match(workspaceSource, /void markAllResponses\(\{ questionNumbers: submittedQuestionNumbers, inkByPage: flushed\.pdfInkByPage, inkQuestionMap, submittedAttempt: true \}\)/)
assert.match(answerSheetSource, /paperStudyModeLabel/)
assert.match(answerSheetSource, /write on paper first, upload a photo, then submit for AI-assisted marking/)
